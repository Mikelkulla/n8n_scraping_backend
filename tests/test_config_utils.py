...
@pytest.mark.parametrize("domain, expected", [
    ...
    ("airbnb.co.uk", True),
    ("www.airbnb.co.uk", True),
    ("www.bayswaterdental.co.uk", False),
    ("example.com", False),
    ("linkedin.com", True),
    ("instagram.com", True),
    ("youtube.com", True),
...
@pytest.mark.parametrize("url, expected_base_url, expected_error", [
    ...
    ("https://www.booking.com/hotel/example", None, "Non-business domain"),
    ("https://dentist.booking.com", None, "Non-business domain"),
    ("https://www.ihg.com", None, "Non-business domain"),
    ("www.bayswaterdental.co.uk", "https://www.bayswaterdental.co.uk", None),
